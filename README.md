...
- Full stack NextJS app written in Typescript that includes role based access control (RBAC),complete Supabase SSR Auth and Postgresql db integration, Resend email server, Zod and YUP! data validation, React Hook form, Shadcn-UI, TailwindCSS and more. Fork, customize, and deploy on Vercel or elsewhere to have your MVP up and running in a few days or less. Stack details are 
below. 

## Stack 
- NextJS 14 App Router
- Supabase 
  - SSR Auth with middleware, server actions, cookies, storage, typed database browser and server clients, query helpers
  - Postgres DB
- Web3Modal powered by Tanstack React Query and Wagmi SSR configuration 
- Resend email server 
