       ...
       <Link
        ...
        >
          What is Da-Fi Token?
              ...
              If you are new to Quantum One DAO, we suggest first reviewing our research and data compendium using the button below. Then connect your wallet to view your Da-Fi Token balance and verify if you received one of our previous randomized airdrops. The 1st 3K Quantum One users can participate in the airdrop by adding their preferred Ethereum address to their Quantum One profile.</p>
