       ...
       <Link
        ...
        >
          What is Da-Fi Token?
              ...
              <p className="max-w-[980px] md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed text-justify"> 
