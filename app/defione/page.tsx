...
<li>Chain-agnostic liquid staking</li>
...
<p className="max-w-[980px] text-lg">In the near term, we are exploring partnership, grant, token sale, and other fundraising options to help fund the launch of DFI1. The final details will be formally announced via press release and, if necessary, in SAFT format over the next quarter. 
</p>


<Separator/>
<p className="max-w-[980px] text-lg"> We have a couple of demo's we're currently working on. DFI1 at defione.io leverages Zetachain to enable multiple cross-chain capabilities including contract-to-contract messaging, token/NFT swaps, and liquidity pools. DFI1 DEX at dex.defione.io is derived from battle tested Uniswap v3 and prepared to swap in our  contracts and APIs upon deployment. Think DeFi Llama with identity authentication, investor accreditation, and the power to harness quantum advantage. </p>
