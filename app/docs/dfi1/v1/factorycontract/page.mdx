...
Calculates the greatest tick value such that getRatioAtTick(tick) $\le$ ratio

_Throws in case sqrtPriceX96 $\lt$ MIN_SQRT_RATIO, as MIN_SQRT_RATIO is the lowest value getRatioAtTick may
ever return._
