...
**[DeFi ONE Token]**, a product of **[DeFi ONE and Quantum One DAO]**

## SAFT
### (Simple Agreement for Future Tokens)

THIS CERTIFIES THAT in exchange for the payment by the undersigned purchaser (the *“Purchaser”*) of $[__________] (the *“Purchase Amount”*) on or about [7/22], 2022, [Quantum One DAO], a [Wyoming] corporation (the *“Company”*), hereby issues to the Purchaser the right (the *“Right”*) to certain units of [DeFi ONE Token] (the *“Token”* or *“[DFI1]”*), subject to the terms set forth below.
